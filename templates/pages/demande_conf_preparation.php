...
<head>
    ...
    <title>Confirmation de préparation</title>
</head>
...
<body>
    ...
    <main class="cont1200">
        <h1 class="mb24">Confirmer la préparation de la commande n° <?=$commande->id()?> ?</h1>
        ...
        <div class="flexwrap g24">
            <a href="finaliser_commande.php?id=<?=$commande->id()?>" class="action-btn">Oui</a>
            <a href="afficher_tableau_de_bord.php" class="action-btn">Non</a>
        </div>
    </main>
</body>
</html>