...
// Template : Affiche une demande de confirmation de suppression du produit
...
<head>
    ...
    <title>Demande de confirmation de suppression du produit</title>
</head>
...
<body>
    ...
    <main class="flexwrap g24 pl64 pr64 mb128 justcenter align-center flexcolumn">
        <h1 class="w100 mb32 textcenter">Voulez vous supprimer ce produit ?</h1>

        <div class="gestion-card w15 p16 flexwrap g16 justcenter align-center">
            <div class="gestion-card-img w80"><img src="/assets/images<?= $produit->getHTML("image") ?>" class="responsive-img"></div>
            <h2 class="mb24 w100 textcenter"><?= $produit->getHTML("nom") ?></h2>
        </div>

        <div class="flexwrap g24">
            <a href="supprimer_produit.php?id=<?= $produit->id() ?>" class="action-btn">Oui</a>
            <a href="afficher_liste_produits.php" class="action-btn">Non</a>
        </div>
    </main>
</body>
